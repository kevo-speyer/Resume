...
\section{PROFESSIONAL EXPERIENCE} 
	{\sl Data Scientist} \hfill 1/2019 - Present \\
		Cybertec Sch\"onig \& Sch\"onig GmbH (Austria)
                 \begin{itemize}  \itemsep -2pt %reduce space between items
		 \item Managed a project to build a BI dashboard engine in 
			 PostgreSQL for a client.			
                \item Researched a cost-effective way to reduce the amount of 
			 backup disks in wharehouse, implementing ML models. 
