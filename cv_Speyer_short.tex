...
\section{PROFESSIONAL EXPERIENCE} {\sl Database Administrator} \hfill 9/2018 - Present \\
		...
		performing PostgreSQL consulting for Rappi (Colombia) 
		 ...
		 \item Diagnosed problems in core Databases regarding
			 health and performance issues.
                 \item Developed a series scripts that run automatically 
			 at mainteinance time to clean up the most deteriorated 
				 Databases. 
                \item Created various Dashboards to keep track of health and 
			performance metrics of the Databases. 
                \end{itemize}
...
\section{EDUCATION} {\sl PhD in Computational Physics}  \hfill 4/2014 - Present \\
		      ...
		      %	Computer Modern (default) font
                Universidad de Buenos Aires, CNEA-CONICET \\ 
                Expected: June 2019 \\
