...
%            using a feedback control loop algorithm and clustering.
        ...
        \item Retrained NLP GPT-2 model fine tunning to texts scrapped from the web
            Selenium and BeautifulSoup.
        \item Implemented Reinforcement Learning (Q-learning) to solve optimize logistics.
    \end{itemize}
